                ...
                <header class="header_wrapper">
                    ...
                    <div class="invoice_id_number">
                        <h6
                            ...
                            "
                            >
                            Invoice No :<?php echo esc($invoice->invoice); ?>
                        </h6>
                    </div>
                </header>
                ...
                <section
                    ...
                    <div class="customer_billing billing_area" style="margin-top: 15px">
                        ...
                        <ul style="margin-left: -40px;">
                            <li
                                ...
                                "
                                >
                                <p style="font-weight: 500;white-space: nowrap;">Customer ID : <?php echo esc($invoice->user_id_num); ?></p>
                              </li>
                            ...
                            <li
                                ...
                                "
                                >
                                <p style="font-weight: 500;white-space: nowrap;">Customer Name : <?php echo esc($invoice->customer_name); ?></p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="customer_billing" style="margin-top: 15px">
                        <div
                            ...
                            <h5 style="font-size: 22px; font-weight: 600"> <?php echo esc($invoice->date); ?></h5>
                        </div>
                    ...
                    <div class="customer_billing market_info" style="margin-top: 15px">
                        ...
                        <ul style="margin-left: -40px;">
                            <li
                                ...
                                "
                                >
                                <p style="white-space: nowrap;">Designation : <?php echo $designationArr[$invoice->designation] ?? ''; ?></p>
                              </li>
                            <li
                                style="
                                font-size: 13px;
                                ...
                                "
                                >
                                <p style="white-space: nowrap;">Department : <?php echo $departmentArr[$invoice->department] ?? ''; ?></p>
                            </li>
                        </ul>
                    </div>
                </section>
                    ...
                    <table
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="border: 1px solid black; font-weight: 600"><?php echo lan('quantity') ?></th>
                                <th style="border: 1px solid black; font-weight: 600">
                                    Return Qty
                                </th>
                                <th style="border: 1px solid black; font-weight: 600"><?php echo lan('price') ?></th>
                                <th style="border: 1px solid black; font-weight: 600">
                                    <?php echo lan('total_amount') ?>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            if ($details) {
                                ...
                                foreach ($details as $details) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid black; text-align: end"><?php echo esc($returnProducts[$details['product_id']] ?? 0) ?></td>
                                        <td style="border: 1px solid black; text-align: end"><?php echo esc(number_format($details['rate'], 2)) ?></td>
...
<!--                                <td colspan="2" style="font-weight: 600">
                                ...
                                <td
                                    style="border: 1px solid black; text-align: end; font-weight: 600"
                                    >
                                        <?php echo esc(number_format($invoice_total_amount - $sum_deduction, 2)); ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <div class="remark_right" style="margin-top: 10px">
                            <ul>
                                <li
                                    ...
                                    "
                                    >
                                    <p style="font-weight: 600;white-space: nowrap;">Created By : <?php echo $userArr[$invoice->sales_by] ?></p>
                                 </li>
