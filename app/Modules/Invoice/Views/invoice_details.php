            ...
            <div class="" id="printArea">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <h3 class="text-uppercase text-success font-weight-600" style="font-size: 16px !important;"><?php echo lan('billing_from') ?></h3>
                        <p class="text-muted mb-4">
                            <strong class="text-body fs-14"><?php echo esc($settings_info->title); ?>.</strong> <br>
                    ...
                    <div class="col-12 col-md-6 text-md-right">
                        <h3 class="text-uppercase text-success font-weight-600" style="font-size: 16px !important;"><?php echo lan('billing_to') ?></h3>
                        <p class="text-muted mb-4">
