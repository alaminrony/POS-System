                    ...
                    <div class="col-md-4">
                        <div class="">
                            ...
                            <select name="payment_type" id="payment_type" onchange="bank_payment(this.value)" class="form-control select2" tabindex="4">
                                ...
                                ?>><?php echo lan('cash_payment') ?></option>
                                <option value="2" <?php
                                if ($invoice->payment_type == 2) {
                                    echo 'selected';
                                }
                                ?>><?php echo lan('bank_payment') ?></option>
                    ...
                    <table class="table table-bordered table-hover table-sm text-nowrap custom-table table-sm text-nowrap" id="normalinvoice">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="display:none;"><?php
...
$this->invoiceModel = new InvoiceModel();
                            if ($details) {
                                ...
                                foreach ($details as $details) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="" id="" class="form-control text-right strip_<?php echo $sl ?> valid" value="<?php echo $leafSetting[$details['product_id']]  ?>" readonly="" aria-invalid="false" type="text">
                                        </td>
                                        <td>
                        ...
                        <tfoot>
                            ...
                            foreach ($taxes as $taxfldt) {
                                ...
                                <tr class="hideableRow hiddenRow collapse" id="collapseExample">
                                    ...
                                    <td class="text-right">
                                        <input id="total_tax_amount<?php echo $x; ?>" tabindex="-1" class="form-control text-right valid totalTax valid_number" name="total_tax<?php echo $x; ?>" value="<?php
                                        $txval = 'tax' . $x;
                                        echo $taxvalu[0][$txval]
                        ...
                        <tr id="change_m"><td class="text-right" colspan="9" id="ch_l"><b><?php echo lan('change') ?>:</b></td>
                            <td class="text-right">
                                <input type="text" id="change" class="form-control text-right" name="change" value="<?php
                                       $change = $invoice->paid_amount - $invoice->total_amount;
                                       if ($change > 0) {
                                           echo $change;
                                       } else {
                                           echo 0;
