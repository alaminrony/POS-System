        ...
        <div class="card ">
            <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('closing_list')?></h6>
                                </div>
                                <div class="text-right">
                                   <a href="<?php echo base_url('report/add_closing')?>" class="btn btn-success btn-sm mr-1"><i class="fas fa-plus mr-1"></i><?php echo lan('add_closing')?></a>
            ...
            <div class="card-body">
             <div class="row">
                ...
                <div class="table-responsive">
                     <table class="table table-striped table-bordered custom-table" cellspacing="0" width="100%" id="ClosingList"> 
                <thead>
                  <tr>
                    <th><?php echo lan('sl_no') ?></th>
                    <th><?php echo lan('last_day_closing') ?></th>
                    <th><?php echo lan('date') ?></th>
                    <th><?php echo lan('receive') ?></th>
                    <th><?php echo lan('payment') ?></th>
                    <th><?php echo lan('balance') ?></th>
                    <th><?php echo lan('closed_by') ?></th>
