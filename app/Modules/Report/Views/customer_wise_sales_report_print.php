        ...
        <div class="card card-body p-5">
            <div class="" id="printArea">
                ...
                <div style="display: flex; padding-top: 10px;">
                    <div style="width: 80%;">
                        <p style="border: 1px solid rgb(202, 202, 202); text-align: left;padding-left: 5px;">Invoice Wise Sales Details (With Return)</p>
                    </div>
                ...
                <div style="padding: 10px 0 0 0;">
                    <table style="border-collapse: collapse; width: 100%; border-bottom: 1px solid black;">
                        ...
                        <tr>
                            ...
                            <th style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: center;">Cus.ID</th>
                            <th style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: center;">Quantity</th>
                            <th style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: center;" colspan="5">TP</th>
...
<!--                            <th style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: center;">Discount
                        ...
                        <?php foreach ($results as $result) { ?>
                            <tr>
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: left;"><?php echo date('d-M-Y', strtotime($result['date'])) ?></td>
                                ...
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: left;"><?php echo $result['customer_id'] ?? '' ?></td>
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: left;"><?php echo $result['quantity'] ?? '' ?></td>
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: center;" colspan="5"><?php echo $result['total_amount'] ?? '' ?></td>
    <!--                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;"><?php echo $result['invoice_discount'] ?? '' ?></td>
                                ...
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;"></td>-->
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;text-align: center;" colspan="5"></td>
    <!--                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;"></td>
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;"></td>
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;"></td>
                                <td style="border: 1px solid #333;padding: 2px;font-size: 10px;"></td>-->
                        ...
                        <tr>
                            <td colspan="4" style="border: 1px solid #333;padding: 2px;font-size: 10px;"></td>
                            <!--<td></td>-->
                            <td style="font-weight: bold;border: 1px solid #333;padding: 2px;font-size: 10px;">Grand Total:</td>
                            <td style="font-weight: bold;border: 1px solid #333;padding: 2px;font-size: 10px;text-align: center" colspan="5"><?php echo $G_total ?? 0 ?></td>
<!--                            <td style="font-weight: bold;border: 1px solid #333;padding: 2px;font-size: 10px;"><?php echo $G_discount ?? 0 ?></td>
                            ...
                            <td style="font-weight: bold;border: 1px solid #333;padding: 2px;font-size: 10px;">N/A</td>-->
                            <td style="font-weight: bold;border: 1px solid #333;padding: 2px;font-size: 10px;text-align: center" colspan="5">0.00</td>
