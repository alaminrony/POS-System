        ...
        <div class="card card-body p-5">
            <div class="" id="printArea">
                <div style="text-align: center;">
                    <h6 style="font-size: 14px; padding: 0; margin: 0;"><?php echo strtoupper($settings_info->title) ?></h6>
                    <p style="padding: 0; margin: 0;">OHQ, Plot:82, Road No.14, Block‐B, Banani</p>
                    <p style="text-decoration: underline; padding: 0; margin: 0;">MEDICINE REQUISITION</p>
                </div>
                ...
                <div style="padding: 20px 0 0 0;">
                    <table 
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #333;padding: 2px;text-align: center;"> <?php echo $details->product_id ?? '' ?></td>
                            <td style="border: 1px solid #333;padding: 2px;text-align: center;"> <?php echo $productArr[$details->product_id] ?? '' ?></td>
                            <td style="border: 1px solid #333;padding: 2px;text-align: center;"><?php echo $details->quantity ?? ''; ?></td>
                ...
                <div style="text-align: center; padding: 20px 0 0 0;">
                    <p style="background: #f2f2f2;"><span>Previous received:</span> <span style="border: 1px solid #000; padding: 0 25px 0 2px;"><?php echo $pre_requisition_data['preReqDate'] ?? ''; ?></span></p>
                </div>
                <?php if(!empty($pre_requisition_data['preSingleReqDetails'])){?>
                <div style="padding: 20px 0 0 0;">
                    <table 
                        style="border-collapse: collapse;
                        width: 100%;"
                        ...
                        <?php $i = 0; ?>
                        <?php
                        foreach ($pre_requisition_data['preSingleReqDetails'] as $preDetails) {
                        ?>
                        <?php $i++; ?>
                        <tr>
                            <td style="border: 1px solid #333;padding: 2px; text-align: center;"><?php echo $i; ?></td>
                            <td style="border: 1px solid #333;padding: 2px;text-align: center;"> <?php echo $preDetails->product_id ?? '' ?></td>
                            <td style="border: 1px solid #333;padding: 2px;text-align: center;"> <?php echo $productArr[$preDetails->product_id] ?? '' ?></td>
                            <td style="border: 1px solid #333;padding: 2px;text-align: center;"><?php echo $preDetails->quantity ?? ''; ?></td>
                            <td style="border: 1px solid #333;padding: 2px;text-align: center;">
                                <?php if($pre_requisition_data['preSingleReq']->status == '2'){ ?>
                                <?php echo $preDetails->quantity ?? ''; ?>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php }?>
